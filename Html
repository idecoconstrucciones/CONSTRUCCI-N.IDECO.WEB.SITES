...
<body>
  ...
  <main>
    ...
    <section id="modelos">
      ...
      <p>🏡 Te ofrecemos modelos de casas previamente diseñados para agilizar tu proyecto. Si preferís algo único, creamos diseños totalmente personalizados que se ajustan a tu estilo, tus ideas y tu presupuesto.</p>
    </section>
    ...
    <section id="ofertas" class="highlight">
      ...
      <ul>
        <li><strong>Descuento del 15%</strong> en materiales de construcción seleccionados.</li>
        <li><strong>Promociones especiales</strong> en modelos de casas listos para construir.</li>
        <li><strong>Planes de financiación flexibles</strong> para proyectos llave en mano.</li>
        <li><strong>Asesoramiento personalizado</strong> para elegir la mejor opción para vos.</li>
      </ul>
      <div class="buttons">
      ...
      <div class="grid">
        <div class="card">
          ...
          <div class="card-content">
            <h3>Obra Nueva</h3>
            <p>Diseñamos y construimos viviendas y edificios desde cero, adaptados a tu presupuesto y estilo.</p>
          </div>
        </div>
        <div class="card">
    ...
    <section id="contacto">
      <h2>Contacto</h2>
      <p>¿Querés más información o una cotización? Comunicate con nosotros por cualquiera de estos medios:</p>
      <div class="buttons">
        <a class="button" href="https://wa.me/543624186258" target="_blank">WhatsApp +54 3624 186258</a>
        <a class="button" href="https://wa.me/543624186257" target="_blank">WhatsApp +54 3624 186257</a>
